...
#since gunicorn is going to be used, this is commented out
'''
...
#PLEASE READ (FRIENDLY REMINDER)
#app.py had to be changed to flask_app.py because....
#gunicorn is going to be confused since we have an app folder and app.py
#gunicorn will read it like this if it wasn't changed to...
#gunicorn "app:app" and this is a problem
#so, it got changed to flask_app:app
